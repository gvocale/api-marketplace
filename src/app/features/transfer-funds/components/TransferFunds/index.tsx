...
import { Code } from "@/app/features/transfer-funds/components/Code";
...
import {
  ...
  JSON_4,
  JSON_5,
} from "@/app/products/transfer-funds/data";
import { Cards } from "../Cards";

export function TransferFunds() {
  const [selected, setSelected] = useState<FinancialMessagingStandard>("swift");
  return (
    <div className={styles.container}>
      ...
      <article className={styles.article}>
        ...
        <section className={styles.section}>
          <h2 className={styles.h2}>Payment Flow</h2>
          ...
          <h3 className={styles.h3}>Initiation</h3>
          <p className={styles.paragraph}>
          ...
          <h3 className={styles.h3}>Message Creation</h3>
          <p className={styles.paragraph}>
          ...
          <h3 className={styles.h3}>Transmission</h3>
          <p className={styles.paragraph}>
          ...
          <h3 className={styles.h3}>Settlement</h3>
          <p className={styles.paragraph}>
          ...
          <h3 className={styles.h3}>Confirmation</h3>
          <p className={styles.paragraph}>
            ...
            <li>
              ...
              <ol>
                ...
                <li>
                  ...
                  <p className={styles.paragraph}>This header typically contains the following fields:</p>
                  <table>
                    <tbody>
                      <tr>
                        <th>
                      ...
                      <tr>
                        <td>
                          <p className={styles.paragraph}>Business Message Identifier</p>
                        </td>
                        <td>
                        ...
                        <td>
                          ...
                          <p className={styles.paragraph}>Min/Max Value/Length: 1 - 35 characters</p>
                        </td>
                      </tr>
                      <tr>
                        <td>
                          <p className={styles.paragraph}>Message Definition Identifier</p>
                        </td>
                        <td>
                        ...
                        <td>
                          ...
                          <p className={styles.paragraph}>
                            For pacs.008, this will be
                            &quot;pacs.008.001.08&quot; or a similar identifier
                            depending on the message version.
                          </p>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>
                          <p className={styles.paragraph}>2020-01-11T12:43:41.960+00:00</p>
                        </td>
                        <td>
                          <p className={styles.paragraph}>
                            Date when this Business Message (header) was
                            created. Note Times must be normalized, using the
                            &quot;Z&quot; annotation using the ISO 8601 UTC
                            annotation.
                          </p>
                        </td>
                      </tr>
                ...
                <li>
                  ...
                  <table>
                    <tbody>
                      ...
                      <tr>
                        <td>
                          <p className={styles.paragraph}>Message Identification</p>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <p className={styles.paragraph}>Number Of Transactions</p>
                        </td>
                        <td>
                        ...
                        <td>
                          ...
                          <p className={styles.paragraph}>Max Value/Length: 15 characters</p>
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td>
                          ...
                          <p className={styles.paragraph}>Possible Enumeration: CLRG, INDA, INGA, COVE</p>
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td>
                          <p className={styles.paragraph}>SttlmInf.SttlmAcct.Id.Othr.Id</p>
                        </td>
                        <td>
                ...
                <li>
                  ...
                  <table>
                    <tbody>
                      ...
                      <tr>
                        <td>
                          <p className={styles.paragraph}>Instruction Identification</p>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <p className={styles.paragraph}>End To End Identification</p>
                        </td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td>
                          <p className={styles.paragraph}>12345678-0000-4000-B000-123456781234</p>
                        </td>
                        <td>
                          <p className={styles.paragraph}>
                      ...
                      <tr>
                        <td>
                          <p className={styles.paragraph}>Interbank Settlement Amount</p>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <p className={styles.paragraph}>Interbank Settlement Date</p>
                        </td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <p className={styles.paragraph}>Enumeration: DEBT, SHAR, or CRED.</p>
                          <p className={styles.paragraph}>
                            <br />
                          </p>
                          <ul>
                      ...
                      <tr>
                        ...
                        <td>
                          <p className={styles.paragraph}>InstdAgt.FinInstnId.BICFI</p>
                        </td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td>
                          <p className={styles.paragraph}>InstgAgt.FinInstnId.BICFI</p>
                        </td>
                        <td>
                          <p className={styles.paragraph}>IRVTUS3NAMS</p>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <p className={styles.paragraph}>IntrmyAgt1.FinInstnId.BICFI</p>
                        </td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td>
                          <p className={styles.paragraph}>This is the original requestor of the funds.</p>
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td>
                          <p className={styles.paragraph}>DbtrAgt.FinInstnId.BICFI</p>
                        </td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td>
                          <p className={styles.paragraph}>
                            This is the final Beneficiary of the funds&apos;
                            name &amp; addressCdtr.PstlAdr.
                          </p>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <p className={styles.paragraph}>PstlAdr.StrtNm.PstCd.TwnNm.Ctry</p>
                        </td>
                        <td>
                          <p className={styles.paragraph}>OMVAL 30000000 TOWN2 NL</p>
                        </td>
                        <td>
                          <p className={styles.paragraph}>Postal address of the creditor.</p>
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td>
                          <p className={styles.paragraph}>CdtrAgt.FinInstnId.BICFI</p>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <p className={styles.paragraph}>Remittance Information</p>
                        </td>
                        <td>
                          <p className={styles.paragraph}>RmtInf.Ustrd</p>
                        </td>
                        <td>
                          <p className={styles.paragraph}>INVOICE A000,0000/04,991/05</p>
                        </td>
                        <td>
                          <p className={styles.paragraph}>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      response for a successful request. Otherwise, an error
                      will be returned.
                    </td>
                  </tr>
                </tbody>
